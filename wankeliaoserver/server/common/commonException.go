...
var clientMsgList = map[string]string{
	...
	"API_CREATEROOM_ROOM_TYPE_ERROR":                                  "001df3d4a8622000", //系统发生错误
	...
	"API_ROOMINFOEDIT_SELECT_USER_ERROR":                              "001df3d4a8622000", //系统发生错误
	...
	"COMMAND_CLEARUSERMSG_ES_DELETE_ERROR":                            "001df3d4a8622000", //系统发生错误
	"COMMAND_CLEARUSERMSG_GUEST":                                      "001df3d4a8622000", //系统发生错误
	"COMMAND_CLEARUSERMSG_JSON_ERROR":                                 "001df3d4a8622000", //系统发生错误
	"COMMAND_CLEARUSERMSG_NOT_ADMIN":                                  "001df3d4a8622000", //系统发生错误
	"COMMAND_CLEARUSERMSG_ROOMUUID_ERROR":                             "001df3d4a8622000", //系统发生错误
	"COMMAND_CLEARUSERMSG_TARGET_IS_ADMIN":                            "001df3d4a8622000", //系统发生错误
	...
	"COMMAND_CREATEPRIVATEROOM_NOT_ADMIN":                             "0020d9959d86c000", //未有权限
	...
	"COMMAND_DISMISSROOM_NOT_ADMIN":                                   "0020d9959d86c000", //未有权限
	...
	"COMMAND_FRIENDINVITE_NOT_ADMIN":                                  "0020d9959d86c000", //未有权限
	...
	"COMMAND_GETLANGLIST_JSON_ERROR":                                  "001df3d4a8622000", //系统发生错误
	"COMMAND_GETLANGLIST_SERVER_LANG_FILE_ERROR":                      "001df3d4a8622000", //系统发生错误
	"COMMAND_GETMEMBERLIST_ERROR":                                     "001df3d4a8622000", //系统发生错误
	...
	"COMMAND_HIERARCHYTOKENSEARCH_USER_SELECT_ERROR":                  "001df3d4a8622000", //系统发生错误
	"COMMAND_KICKROOMUSER_GUEST":                                      "0020d9959d86c000", //未有权限
	"COMMAND_KICKROOMUSER_JSON_ERROR":                                 "001df3d4a8622000", //系统发生错误
	"COMMAND_KICKROOMUSER_NOT_ADMIN":                                  "0020d9959d86c000", //未有权限
	...
	"COMMAND_PLAYERSENDMSG_IS_NEW_USER":                               "00245f864d000700", //信息未送出，喵星人需要一天的时间来习惯你的到来~
	...
	"COMMAND_ROOMADMINADD_NOT_ADMIN":                                  "0020d9959d86c000", //未有权限
	...
	"COMMAND_ROOMINFOEDIT_INSERT_DB_ERROR":                            "001df3d4a8622000", //系统发生错误
	"COMMAND_ROOMINFOEDIT_JSON_ERROR":                                 "001df3d4a8622000", //系统发生错误
	"COMMAND_ROOMINFOEDIT_NOT_ADMIN":                                  "0020d9959d86c000", //未有权限
	...
	"COMMAND_ROOMINFOEDIT_ROOM_NAME_DIRTY_WORD":                       "0020d9989f66c000", //请重新命名
	"COMMAND_ROOMINFOEDIT_ROOM_NAME_ERROR":                            "0020d9989f66c000", //请重新命名
	"COMMAND_ROOMINFOEDIT_ROOM_TYPE_ERROR":                            "001df3d4a8622000", //系统发生错误
	"COMMAND_ROOMINFOEDIT_ROOM_UUID_ERROR":                            "001df3d4a8622000", //系统发生错误
	"COMMAND_ROOMINFOEDIT_TARGET_IN_ROOM":                             "001df3d4a8622000", //系统发生错误
	...
	"COMMAND_SIDETEXTDELETE_KILLMESSAGE_NOT_ADMIN":                    "0020d9959d86c000", //未有权限
	...
	"COMMAND_SIDETEXTSEND_GUEST":                                      "0020d9959d86c000", //未有权限
	...
	"COMMAND_TARGETADDROOMBATCH_NOT_ADMIN":                            "0020d9959d86c000", //未有权限
	"COMMAND_TARGETADDROOMBATCH_QUERY_MEMBER_ERROR":                   "001df3d4a8622000", //系统发生错误
	...
	"COMMAND_TOKENCHANGE_USERCHECK_CHECKPLATFORMUSER_ERROR":           "001df3d4a8622000", //系统发生错误
	"COMMAND_TOKENCHANGE_USERCHECK_ERROR":                             "001df3d4a8622000", //系统发生错误
	"COMMAND_TOKENCHANGE_USERCHECK_SELECT_PRIVATEGROUPUSERLIST_ERROR": "001df3d4a8622000", //系统发生错误
	"COMMAND_TOKENCHANGE_USERCHECK_SELECT_VIPGROUPUSERLIST_ERROR":     "001df3d4a8622000", //系统发生错误
	"COMMAND_TOKENCHANGE_USERCHECK_USER_INSERT_ERROR":                 "001df3d4a8622000", //系统发生错误
	"COMMAND_TOKENCHANGE_USERCHECK_USER_SELECT_ERROR":                 "001df3d4a8622000", //系统发生错误
	...
	"COMMON_CHECKPLATFORMUSER_NEW_REQUEST_ERROR":                      "001df3d4a8622000", //系统发生错误
	...
	"COMMON_GETPLATFORMUSER_BODY_ERROR":                               "001df3d4a8622000", //系统发生错误
	"COMMON_GETPLATFORMUSER_JSON_ERROR":                               "001df3d4a8622000", //系统发生错误
	"COMMON_GETPLATFORMUSER_NEW_REQUEST_ERROR":                        "001df3d4a8622000", //系统发生错误
	"COMMON_GETPLATFORMUSER_PLATFORM_UUID_ERROR":                      "001df3d4a8622000", //系统发生错误
	"COMMON_GETPLATFORMUSER_REQUEST_ERROR":                            "001df3d4a8622000", //系统发生错误
	...
	"COMMON_HIERARCHYMEMBERCOUNT_QUERY_DB_ERROR":                      "001df3d4a8622000", //系统发生错误
	...
	"COMMON_HIERARCHYTARGETINFOSEARCH_TARGET_UUID_NULL":               "001df3d4a8622000", //系统发生错误
	"COMMON_HIERARCHYTOKENSEARCH_GETPLATFORMUSER_ERROR":               "001df3d4a8622000", //系统发生错误
	"COMMON_HIERARCHYTOKENSEARCH_INSERT_USER_ERROR":                   "001df3d4a8622000", //系统发生错误
	"COMMON_HIERARCHYTOKENSEARCH_ROOM_INSERT_ERROR":                   "001df3d4a8622000", //系统发生错误
	"COMMON_HIERARCHYTOKENSEARCH_ROOM_READ_ERROR":                     "001df3d4a8622000", //系统发生错误
	"COMMON_QUERYBLOCKIPLIST_ERROR":                                   "001df3d4a8622000", //系统发生错误
	"COMMON_QUERYBLOCKLIST_ERROR":                                     "001df3d4a8622000", //系统发生错误
	"COMMON_QUERYFUNCTIONMANAGEMENT_ERROR":                            "001df3d4a8622000", //系统发生错误
	"COMMON_QUERYGLOBALMESSAGE_ERROR":                                 "001df3d4a8622000", //系统发生错误
	...
	"MAIN_ECHOHANDLER_IP_ERROR":                                       "001df3d4a8622000", //系统发生错误
	...
	"SHELL_LINKPROCLAMATION_CONTENT_TOOLONG":                          "001df3d008622000", //内容超过50字元
	"SHELL_LINKPROCLAMATION_DELETE_DB_ERROR":                          "001df3d4a8622000", //系统发生错误
	"SHELL_LINKPROCLAMATION_INSERT_DB_ERROR":                          "001df3d4a8622000", //系统发生错误
	"SHELL_LINKPROCLAMATION_ORDER_ERROR":                              "001df3da1f922000", //排序设定错误
	"SHELL_LINKPROCLAMATION_ROLE_ERROR":                               "0020d9959d86c000", //未有权限
	"SHELL_LINKPROCLAMATION_SHELL_ERROR":                              "001df3d742e22000", //指令设定错误
	"SHELL_LINKPROCLAMATION_TITLE_TOOLONG":                            "00230ce48c000700", //标题超过10字元
	"SHELL_NORMALPROCLAMATION_CONTENT_TOOLONG":                        "001df3d008622000", //内容超过50字元
	"SHELL_NORMALPROCLAMATION_DELETE_DB_ERROR":                        "001df3d4a8622000", //系统发生错误
	"SHELL_NORMALPROCLAMATION_INSERT_DB_ERROR":                        "001df3d4a8622000", //系统发生错误
	"SHELL_NORMALPROCLAMATION_ROLE_ERROR":                             "0020d9959d86c000", //未有权限
	"SHELL_NORMALPROCLAMATION_SHELL_ERROR":                            "001df3d742e22000", //指令设定错误
	"SHELL_NORMALPROCLAMATION_TITLE_TOOLONG":                          "00230ce48c000700", //标题超过10字元
	"SHELL_QUERYBLOCKLIST_JSON_ERROR":                                 "00245f864d000700", //指令发送失败
	"SHELL_QUERYBLOCKLIST_PARAMETER_ERROR":                            "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_JSON_ADMINSET_ERROR":                             "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_OCTOPUS_URL_ERROR":                               "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_PARAMETER_ERROR":                                 "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_PATCH_ERROR":                                     "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_REQUEST_ERROR":                                   "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_SELECT_ADMINSET_ERROR":                           "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_SELECT_USER_ERROR":                               "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_SHELL_ERROR":                                     "00245f864d000700", //指令发送失败
	"SHELL_SHELLDEMO_TIME_ERROR":                                      "00245f864d000700", //指令发送失败
	"SHELL_SHELL_SHELL_ERROR":                                         "00245f864d000700", //指令发送失败
}
...
func Esclientslog(msg string, loginUuid string, userUuid string) {
	...
	sysErrorLog := Syserrorlog{Code: loginUuid, Useruuid: userUuid, Message: msg, Stamp: timeUnix}
	sysErrorLogJson, _ := json.Marshal(sysErrorLog)
	Esinsert(os.Getenv("clientsLog"), string(sysErrorLogJson))
